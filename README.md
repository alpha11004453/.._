...
<head>
    ...
    <title>Airdrop Invitations - Abdulwehab Jemal</title>
    <style>
        body {
            margin: 0;
        ...
        h1 {
            font-size: 4em; /* Increased font size for the main heading */
            margin: 0;
            color: #00ffcc;
            text-shadow: 2px 2px 10px rgba(0, 255, 204, 0.5);
            font-family: 'Lucida Handwriting', cursive; /* Stylish font for main heading */
        }
